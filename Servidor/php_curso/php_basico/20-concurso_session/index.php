  ...
  <div class="container">
    <div class="formularios">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
          if (empty($_POST['name'])) {
            ...
            if (!isset($_SESSION['concursantes'])) {
              $_SESSION['concursantes'] = array();
            }
            array_push($_SESSION['concursantes'], $_POST['name']);
      ...
      <div>
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
          ...
          $listaGanadores = asignarGanadores(count($listaPremios), count($_SESSION['concursantes']), $listaPremios);
        }
        ?>
      </div>
    </div>
    ...
    <div class="resultado">
      <div class="lista-concursantes">
        ...
        <ol>
          <?php
          foreach ($_SESSION['concursantes'] as $nombre) {
            echo "<li>$nombre</li>";
          }
